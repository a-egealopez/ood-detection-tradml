...
class SyntheticDatasetGenerator:
    ...
    @staticmethod
    def _blobs(n_samples: int, contamination: float, rng: np.random.RandomState) -> Tuple:
    ...
    @staticmethod
    def _moons(n_samples: int, contamination: float, rng: np.random.RandomState) -> Tuple:
    ...
    @staticmethod
    def _circles(n_samples: int, contamination: float, rng: np.random.RandomState) -> Tuple:
    ...
    @staticmethod
    def _swiss_roll(n_samples: int, contamination: float, rng: np.random.RandomState) -> Tuple:
